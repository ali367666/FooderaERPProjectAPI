...
public interface IWarehouseRepository
{
    ...
    Task<Domain.Entities.Warehouse?> GetByIdWithResponsibleAsync(int id, int companyId, CancellationToken cancellationToken);
    ...
    Task<List<Domain.Entities.Warehouse>> GetByCompanyIdWithResponsibleAsync(int companyId, CancellationToken cancellationToken);
