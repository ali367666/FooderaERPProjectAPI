...
public interface IPositionRepository
{
    ...
    /// <summary>Load by primary key <see cref="Domain.Entities.Position.Id"/> only (tracked entity).</summary>
    Task<Domain.Entities.Position?> GetByIdAsync(int id, CancellationToken cancellationToken);
