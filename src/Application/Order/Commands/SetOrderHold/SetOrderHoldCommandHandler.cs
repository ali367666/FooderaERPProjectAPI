...
public class SetOrderHoldCommandHandler : IRequestHandler<SetOrderHoldCommand, OrderResponse>
{
    private readonly IOrderRepository _orderRepository;
    private readonly ICurrentUserService _currentUserService;

    public SetOrderHoldCommandHandler(
    ...
    public async Task<OrderResponse> Handle(SetOrderHoldCommand request, CancellationToken cancellationToken)
    {
        ...
        order.HoldUntilUtc = request.Hold ? DateTime.UtcNow : null;
